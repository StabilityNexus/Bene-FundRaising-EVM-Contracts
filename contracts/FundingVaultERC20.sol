 ...
 */
contract FundingVaultERC20 is Initializable, ERC20Upgradeable  {
    // Errors //
    ...
    function initialize(VaultTypes.VaultConfig calldata config) external initializer  {
        ...
        developerFeeAddress = config.developerFeeAddress;
        developerFeePercentage = config.developerFeePercentage;
    ...
    function purchaseTokens(uint256 fundingAmount) external {
        ...
        amountRaised = amountRaised + fundingAmount;
